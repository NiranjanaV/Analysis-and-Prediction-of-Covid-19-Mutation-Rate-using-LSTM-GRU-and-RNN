...
Original file is located at
    https://colab.research.google.com/drive/1ABwhniln59zrpUT-xvfxYb3bOjK_er6M
"""

import numpy as np
import pandas as pd

df = pd.read_excel("reference_final.xlsx", usecols="A")
reference = df.iloc[0][0]

df1 = pd.read_excel("sequence_length.xlsx", usecols="A")
...
train = mt[0:train_size]
test = mt[train_size:len(dataset)]
