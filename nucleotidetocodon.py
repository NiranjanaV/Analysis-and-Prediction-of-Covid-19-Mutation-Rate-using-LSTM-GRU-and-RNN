# -*- coding: utf-8 -*-
"""nucleotidetocodon.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/16-bj-kctCGVfVQs-xm9yCdbQ-3O-IJfv
"""
...
writer = pd.ExcelWriter('sequenceCodon.xlsx')
...
writer = pd.ExcelWriter('referenceCodon.xlsx')
df.to_excel(writer, sheet_name='Sheet1', index=False)
writer.save()